...
from 2c2p_python_sdk.pydantic.payment_initialization import PaymentInitialization

class PaymentInitializationResponse(BaseModel):
    initialization: typing.Optional[PaymentInitialization] = Field(None, alias='initialization')
