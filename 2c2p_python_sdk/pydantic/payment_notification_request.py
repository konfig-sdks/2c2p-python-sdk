...
class PaymentNotificationRequest(BaseModel):
    ...
    plateform: typing.Optional[typing.Optional[str]] = Field(None, alias='plateform')

    recipient_i_d: typing.Optional[typing.Optional[str]] = Field(None, alias='recipientID')

    recipient_name: typing.Optional[typing.Optional[str]] = Field(None, alias='recipientName')
