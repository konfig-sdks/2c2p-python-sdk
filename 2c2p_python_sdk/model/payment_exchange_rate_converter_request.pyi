...
class PaymentExchangeRateConverterRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["paymentToken", "bin", "locale", "clientID", "browserDetails", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["paymentToken", "bin", "locale", "clientID", "browserDetails", ], str]):
