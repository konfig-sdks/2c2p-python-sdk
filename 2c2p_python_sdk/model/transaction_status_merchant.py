...
class TransactionStatusMerchant(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "address", "email", "logoUrl", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "address", "email", "logoUrl", ], str]):
