...
class PaymentResponseBase(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["respCode", "respDesc", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["respCode", "respDesc", ], str]):
