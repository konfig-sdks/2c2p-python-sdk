...
class ResponsePaymentChannel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "sequenceNo", "name", "code", "iconUrl", "logoUrl", "default", "channelCode", "agentChannelCode", "optionName", "paymentCode", "qrType", "expirationTimer", "expirationDescription", "expiration", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "sequenceNo", "name", "code", "iconUrl", "logoUrl", "default", "channelCode", "agentChannelCode", "optionName", "paymentCode", "qrType", "expirationTimer", "expirationDescription", "expiration", ], str]):
