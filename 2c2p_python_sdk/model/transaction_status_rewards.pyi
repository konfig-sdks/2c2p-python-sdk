...
class TransactionStatusRewards(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["totalPrice", "totalAmount", "name", "type", "amount", "quantity", "price", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["totalPrice", "totalAmount", "name", "type", "amount", "quantity", "price", ], str]):
