...
class PaymentRequestV43(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def payment() -> typing.Type['PaymentParamsRequestV43']:
                return PaymentParamsRequestV43
            
            
            class responseReturnUrl(
                schemas.StrBase,
                schemas.NoneBase,
                schemas.Schema,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment"]) -> 'PaymentParamsRequestV43': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["responseReturnUrl"]) -> MetaOapg.properties.responseReturnUrl: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["paymentToken", "payment", "responseReturnUrl", "clientIP", "locale", "clientID", "browserDetails", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment"]) -> typing.Union['PaymentParamsRequestV43', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["responseReturnUrl"]) -> typing.Union[MetaOapg.properties.responseReturnUrl, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["paymentToken", "payment", "responseReturnUrl", "clientIP", "locale", "clientID", "browserDetails", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        payment: typing.Union['PaymentParamsRequestV43', schemas.Unset] = schemas.unset,
        responseReturnUrl: typing.Union[MetaOapg.properties.responseReturnUrl, None, str, schemas.Unset] = schemas.unset,
        clientIP: typing.Union[MetaOapg.properties.clientIP, None, str, schemas.Unset] = schemas.unset,
