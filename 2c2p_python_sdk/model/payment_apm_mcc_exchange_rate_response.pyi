...
class PaymentApmMccExchangeRateResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class fxRates(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CurrencyAPMMCCFxRate']:
                        return CurrencyAPMMCCFxRate
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["fxRates", "paymentToken", "respCode", "respDesc", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["fxRates", "paymentToken", "respCode", "respDesc", ], str]):
