...
class PaymentBaseRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["paymentToken", "locale", "clientID", "browserDetails", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["paymentToken", "locale", "clientID", "browserDetails", ], str]):
