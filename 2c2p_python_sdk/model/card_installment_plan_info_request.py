...
class CardInstallmentPlanInfoRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["paymentToken", "cardNo", "bankCode", "locale", "clientID", "browserDetails", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["paymentToken", "cardNo", "bankCode", "locale", "clientID", "browserDetails", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        bankCode: typing.Union[MetaOapg.properties.bankCode, None, str, schemas.Unset] = schemas.unset,
