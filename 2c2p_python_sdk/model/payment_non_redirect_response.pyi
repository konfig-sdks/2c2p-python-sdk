...
class PaymentNonRedirectResponse(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["invoiceNo", "channelCode", "respCode", "respDesc", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["invoiceNo", "channelCode", "respCode", "respDesc", ], str]):
